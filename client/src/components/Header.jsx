...
export default function Header() {
    ...
    useEffect(() => {
        ...
        Promise.resolve().then(() => {
            setSearchTerm(prev => prev !== searchTermFromUrl ? searchTermFromUrl : prev);
        });
    }, [location.search]);
    ...
    return (
        <Navbar className="border-b-2">
            ...
            <NavbarCollapse>
                ...
                <NavbarLink active={path === "/search" && !location.search} as="div">
                    <Link to="/search">All posts</Link>
                </NavbarLink>
                <NavbarLink as="div" className="cursor-pointer">
                    <Dropdown inline label="Categories">
                        <Link to="/search?category=tipstricks" className="w-full">
                            <DropdownItem>Tips & Tricks</DropdownItem>
                        </Link>
                        <Link to="/search?category=news" className="w-full">
                            <DropdownItem>News</DropdownItem>
                        </Link>
                        <Link to="/search?category=ai" className="w-full">
                            <DropdownItem>AI</DropdownItem>
                        </Link>
                        <Link to="/search?category=uncategorized" className="w-full">
                            <DropdownItem>Uncategorized</DropdownItem>
                        </Link>
                    </Dropdown>
                </NavbarLink>
