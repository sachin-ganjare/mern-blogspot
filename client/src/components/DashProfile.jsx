        ...
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form className='flex flex-col gap-4'>
                <div className="w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden">
                    <img src={currentUser.profilePicture} alt="user" className='rounded-full w-full h-full object-cover border-8 bordder-[lightgray] overflow-hidden rounded-full'></img>
                </div>
